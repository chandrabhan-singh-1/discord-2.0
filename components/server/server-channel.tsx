...
export const ServerChannel = ({
  ...
  return (
    ...
    >
      ...
      <p
        className={cn(
          "line-clamp-1 text-left font-semibold text-xs text-zinc-400 dark:group-hover:text-zinc-300 transition ",
      ...
      {channel.name === "general" && (
        <ActionTooltip label="Cannot Edit" side="top" align="start">
