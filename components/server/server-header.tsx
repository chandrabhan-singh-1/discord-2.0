      ...
      <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px]">
        ...
        {isAdmin && (
          <DropdownMenuItem
            ...
            className="text-rose-600 focus:text-rose-600 px-2 py-2 text-sm cursor-pointer"
          >
            Delete Server
        ...
        {!isAdmin && (
          <DropdownMenuItem
            ...
            className="px-2 py-2 text-sm text-rose-600 focus:text-rose-600 cursor-pointer"
          >
            Leave Server
